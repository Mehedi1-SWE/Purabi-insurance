export default function NewsEvents() {
    return (
        <section className=" h-[863.39px] w-[1440px] flex-col gap-[30px] px-[80px] py-[100px]">
            {/* LAYOUT 1 */}
            ...
            {/* LAYOUT 2 */}
            <div className="flex h-[505px] w-[1280px] shrink-0 gap-[20px]">
                {/* CARD 1 */}
                <article className="box-border flex h-[505px] w-[413.3333px] shrink-0 flex-col rounded-[20px] bg-white p-[10px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)]">
                    <img
                        src="/news.png"
                        alt="News and Events"
                    ...
                    <div className="flex h-[235px] w-[393.3333px] flex-col gap-[16px] p-[10px]">
                        ...
                        <button type="button" className="flex h-[47px] w-[197px] shrink-0 items-center justify-center gap-[15px] rounded-[5px] border border-[#44444433] bg-[#AC3E25] px-[50px] py-[10px] font-[Poppins] text-[18px] font-normal leading-[100%] text-white">
                            Read More
                        </button>
                    </div>
                </article>
                ...
                <article className="box-border flex h-[505px] w-[413.3333px] shrink-0 flex-col rounded-[20px] bg-white p-[10px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)]">
                    ...
                    <div className="flex h-[235px] w-[393.3333px] flex-col gap-[16px] p-[10px]">
                        ...
                        <h3 className="h-[27px] w-[373.3333px] shrink-0 font-[Open_Sans] text-[22px] font-semibold leading-[26.4px] text-[#211F38]">
